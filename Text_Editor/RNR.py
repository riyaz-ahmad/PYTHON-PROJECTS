...
main_application.title('RNR text editor')
main_application.wm_iconbitmap('icon1.ico')
...
# Functions of font family and font size
...
#   ######### Buttons Functioning #####
#  Bold Button Functioning
def change_bold():
    text_property = tk.font.Font(font=text_editor['font'])  # default things
